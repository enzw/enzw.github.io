...
export const labels = { INCOME: "Pemasukan", EXPENSE: "Pengeluaran", SAVING: "Tabungan", TRANSFER: "Pindah saldo", PRIMARY: "Utama", SECONDARY: "Tambahan", FIXED: "Tetap", VARIABLE: "Variabel", SUBSCRIPTION: "Langganan", DEBT: "Hutang", DISCRETIONARY: "Keinginan", CASH: "Tunai", BANK: "Bank", E_WALLET: "E-wallet" } as const
