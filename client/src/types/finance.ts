...
export type SavingGoalParticipant = Pick<User, "id" | "name" | "avatarEmoji">
export type SavingGoal = { id: string; name: string; targetAmount: number | string; targetDate?: string | null; priority: number; plannedMonthlyAmount: number | string; isShared: boolean; shareCode?: string | null; shareCodeExpiresAt?: string | null; shareCodeExpiresInSeconds?: number; isOwner: boolean; owner: SavingGoalParticipant; participants: SavingGoalParticipant[]; currentTotal: number; actualThisMonth: number }
