...
export type SavingGoal = { id: string; name: string; targetAmount: number | string; targetDate?: string | null; priority: number; plannedMonthlyAmount: number | string; isShared: boolean; shareCode?: string | null; isOwner: boolean; owner: SavingGoalParticipant; participants: SavingGoalParticipant[]; currentTotal: number; actualThisMonth: number }
